...
export function categoryModuleActions(category: ModuleCategory): CategoryModuleAction[] {
  if (category === 'data') {
    return [
      ...
      { key: 'open-module:sqlserver', labelKey: 'nav.sqlserver', icon: 'sqlserver', moduleId: 'sqlserver' },
      { key: 'open-module:postgres', labelKey: 'nav.postgres', icon: 'postgres', moduleId: 'postgres' },
