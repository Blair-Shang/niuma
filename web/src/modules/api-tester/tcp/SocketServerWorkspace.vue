...
/**
 * TCP / UDP 服务端：绑定端口、看接入、收发。工作台在 tcp/，udp register 复用。
 */
...
<template>
  <div class="nm-api-sock">
    ...
    <RsSplitPane :panes="stagePanes" orientation="vertical" class="nm-api-sock__split" with-handle>
      <template #stage>
        <RsSplitPane :panes="bodyPanes" orientation="horizontal" class="nm-api-sock__stage" with-handle>
          <template #peers>
