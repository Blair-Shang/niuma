...
export const ORACLE_FK_ACTIONS = ['NO ACTION', 'RESTRICT', 'CASCADE', 'SET NULL'] as const
...
const ORACLE_DEFAULT_HEX_BIT_RE = /^(0x[0-9a-fA-F]+|[xX]'[0-9a-fA-F]*'|[bB]'[01]*')$/
...
export function formatOracleDefaultExpr(expr: string): string {
  ...
  if (ORACLE_DEFAULT_HEX_BIT_RE.test(e)) return e
