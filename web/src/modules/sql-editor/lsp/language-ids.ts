/** MySQL Monaco / Bridge LSP languageId（与 ensureMysqlLspLanguage 一致）。 */
export const MYSQL_MONACO_LANGUAGE_ID = 'mysql' as const

/** Dameng Monaco / Bridge LSP languageId（与 ensureDamengLspLanguage 一致）。 */
export const DAMENG_MONACO_LANGUAGE_ID = 'dameng' as const
