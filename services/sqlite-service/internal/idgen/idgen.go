// Package idgen 为 sqlite-service 提供会话 ID 等应用层唯一标识生成。
package idgen
...
// NewSnowflake 为指定 worker ID 创建生成器。
