...
const (
	...
	MethodCatalogCreateDatabase   = "catalog.createDatabase"
	MethodCatalogRenameCollection = "catalog.renameCollection"
	MethodCatalogRenameDatabase   = "catalog.renameDatabase"
...
func (d *Dispatcher) dispatch(ctx context.Context, req Request) Response {
	...
	case MethodCatalogCreateDatabase:
		return d.catalogCreateDatabase(ctx, req)
	case MethodCatalogRenameCollection:
		return d.catalogRenameCollection(ctx, req)
	case MethodCatalogRenameDatabase:
		return d.catalogRenameDatabase(ctx, req)
