// Package handler 实现 kingbase-service 的 IPC 方法分发。
package handler
...
import (
	...
	"niuma/pkg/sqllsp"
	"niuma/services/kingbase-service/internal/dataio"
...
type Dispatcher struct {
	...
	kbParser *kingbaseparser.Parser
}
...
func (d *Dispatcher) noteIfLostFrom(req Request, resp Response) {
	...
	event.NoteLost(emit, "kingbase", event.SessionIDFromParams(req.Params), errors.New(resp.Error), d.sessions.Close)
}
