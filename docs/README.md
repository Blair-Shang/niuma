...
| [36-api-module.md](./36-api-module.md) | **API 管理 L1（P0 TCP/UDP；原生 HTTP/TLS 见 §8）** |
| [37-api-workbench.md](./37-api-workbench.md) | **API 调试工作台（集合 v2 / 环境 / Auth；Postman·Apifox 对照与 P1 计划）** |
| [38-api-run.md](./38-api-run.md) | **API 压测与 Collection Runner（schema + platform 契约预留）** |
| [39-api-mock.md](./39-api-mock.md) | **API 本机 HTTP Mock（P2；`platform.api.mock.*`）** |
...
| v0.37 | 2026-09-17 | 新增 37 API 工作台、38 压测 Runner；36 增文档分工与 §8 路线图 |
| v0.38 | 2026-09-17 | 新增 39 本机 HTTP Mock；37 保留 Mock（P2） |
